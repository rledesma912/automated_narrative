...
class MemoryJournalist:
    ...
    async def update_journal(
        ...
        prompt = self._build_journal_prompt(story, beat, previous_journal)
    ...
    def _build_journal_prompt(
        ...
        story: Story,
        beat: Beat,
        previous_journal: Optional[NarrativeJournal],
    ) -> str:
...
REGISTRO ANTERIOR:
- Últimos eventos: {prev_events}
- Misterios sin resolver: {prev_mysteries}

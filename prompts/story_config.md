...
## Título
La presencia en el turno noche

## Protagonista
Adrián desprecia las historias de fantasmas; cree que todo tiene una explicación técnica.

## Sinopsis
Adrían llega al hospital en su turno noche, mientras todos los trabajadores dejan el lugar.
Se saluda con su colega Carlos que es el guardia verpertino que también va de salida.
Las cámaras de seguridad muestran de la sala donde trabaja Adrían comienzan a mostrar una figura estática en el centro del pasillo que desaparece cuando Adrián llega al lugar.
La tensión crece cuando la figura no aparace y los cortes de luz dejan en varias ocaciones a Adrian en la total obscuridad.
Con mucho miedo intenta salir del hospital pero las llaves maestran no abren las puertas.

# ESTRUCTURA DE LOS 5 ACTOS
...
- La estatica y la figura sombría en los minitores de la sala de vigilancia
- Los cortes de luz que lo hacen sufrir de miedo. Se siente perseguido.
- La linterna y el celular que fallan en los peores momentos.
- Las llaves maestras que no abren las puertas del hospital.

# REGLAS DE LA HISTORIA (Inamovibles):
- Adrián se queda TOTALMENTE SOLO. No hay otros guardias ni médicos.
- El terror es VISUAL (monitores) y SONORO (pasos/radio).
- Adrián es un tipo duro y escéptico, no tiene "voces en su cabeza".
- Todo el relato ocurre en PASADO (ej: "Caminé", "Vi", "Sentí").
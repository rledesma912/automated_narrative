...
class TestTemplateMapper:
    ...
    def valid_input(self):
        return TemplateInput(
            ...
            tono="oscuro",
            escenarios="Una casa abandonada en las afuera",
    ...
    def test_map_basic_fields(self, mapper, valid_input):
        ...
        assert story.genero == "terror"
        assert story.subgenero == "psicologico"
        assert story.tono == "oscuro"
    ...
    def test_map_keeps_spanish_fields(self, mapper, valid_input):
        ...
        assert story.scenarios[0].name == "Una casa abandonada en las afuera"

...
> **Supersedido por Spec 044** (`specs/044_response_normalizer_scope.md`): el scope del
> `ResponseNormalizer` fue redefinido. Los Hitos 3 y 4 quedan como referencia histórica.
> La arquitectura YAML de config LLM (Hitos 1–2) sigue vigente sin cambios.
